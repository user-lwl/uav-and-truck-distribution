...
# 导入距离
#df = pd.read_excel("附件2_3.xlsx", sheet_name="问题2、问题3各地点之间距离（单位 公里）", index_col=0, header=0)
df = pd.read_excel("附件3_x_x.xlsx", sheet_name="问题4各地点之间距离（单位  公里）", index_col=0, header=0)
# 去除nan
